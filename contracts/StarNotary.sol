...
contract StarNotary is ERC721 {
    ...
    string public starNotaryName;
    string public symbol;

    constructor() public {
        starNotaryName = "Star Notary";
        symbol = "ST";
    }
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        bool check1 = _isApprovedOrOwner(msg.sender, _tokenId1);
        bool check2 = _isApprovedOrOwner(msg.sender, _tokenId2);
